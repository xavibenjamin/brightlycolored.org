...
{% assign myPosts = site.posts | where: 'author', page.author %}
...
{% figure alignleft /uploads/2017/12/izzy.jpg "Izzy doesn’t fit in a box on my desk anymore, but she’s just as&nbsp;cute." %}
